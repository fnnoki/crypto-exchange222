    ...
    if db.query(Order).count() == 0:
        ...
        demo_orders = [
            ...
            Order(order_id="E5F6G7H8", created_at=datetime.now()-timedelta(hours=2),
                  amount_usdt=120.0, amount_rub=8804.50, rate_at_creation=75.64,
                  commission_percent=3.0, commission_amount=272.30,
            ...
            Order(order_id="J9K0L1M2", created_at=datetime.now()-timedelta(days=2),
                  amount_usdt=250.0, amount_rub=18342.70, rate_at_creation=75.64,
                  commission_percent=3.0, commission_amount=567.30,
            ...
            Order(order_id="P7R8S9T0", created_at=datetime.now()-timedelta(hours=48),
                  amount_usdt=500.0, amount_rub=38954.60, rate_at_creation=75.64,
                  commission_percent=3.0, commission_amount=1134.60,
